<header sticky>
  ...
  <dropdown header="CS3281" class="nav-link">
    ...
    <li><a href="{{baseUrl}}/schedule/index-cs3281.html" class="dropdown-item">Schedule</a></li>{% if not is_pre_sem %}
    <li><a href="{{ students_site }}/index.html" target="_blank"class="dropdown-item">Students</a></li>
    <li><a href="https://github.com/nus-cs3281/{{ year }}" target="_blank"class="dropdown-item">Students Repo</a></li>{% endif %}
  </dropdown>
