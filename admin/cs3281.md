...
* **Achievements** [50%]:
  * Measures the quality, depth, and quantity of your work, mainly in relations to your project.<br>
...
* **Learning** [35%]: this component is an incentive for you to learn the relevant tools and technologies well. The learning of AI tools (i.e., how well you learned to use AI tools) will be the main factor for this component. Deliverables:
  * Written reflections
  * Demos and other form of sharing
  * Use of AI tools in the course
* **Conduct** [5+5+5=15%]:
  * **Professional conduct** [5%]: e.g., _punctuality_, _reliability_, _participation_, etc.
  * **Teamwork** [5%]: e.g., willing to contribute to common tasks, work as a team rather than work in isolation, give due considerations to the needs of the project rather than consider what is good for own grades only.
  * **Consistency** [5%]: this component is an incentive for you to spread the work across the semester. To earn full marks, you should meet both these criteria.
    ...
    * Merged PRs in at least 5 weeks. For this criterion, PR merges can be credited to future weeks but not past weeks. e.g. if you happen to merge two PRs in a week, one can be counted for that week and the other for a future week (but not for a past week).
