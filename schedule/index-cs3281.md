...
* Agenda
  * 10-11am: A common Zoom session for students and  mentors to introduce themselves. Try to join from a private location where you can **use the webcam and appear without a mask**. The Zoom link will be posted in LumiNUS.
  ...
  * 4-5.30pm: Prof to meet with each team separately for a short debriefing. Optional for mentors to join.<br>
...
* Demo the product created by your project.
  * MarkBind, RepoSense, TEAMMATES: ~20 minutes each<br>
    CATcher: 10-15 minutes (you may also demo Electron if not enough things to demo in CATcher)
